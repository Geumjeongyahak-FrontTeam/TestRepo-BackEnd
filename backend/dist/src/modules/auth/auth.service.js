...
let AuthService = class AuthService {
    constructor(jwtService, usersRepository, teachersRepository) {
    ...
    async login(loginDto) {
        ...
        if (!user) {
            throw new common_1.UnauthorizedException('Incorrect ID or Password.');
        }
...
AuthService = __decorate([
    ...
    __param(2, (0, typeorm_1.InjectRepository)(person_entity_1.TeacherEntity)),
